      ...
      <div class="row">
        <div class="col">
          ...
          <nav class="navbar navbar-light bg-light">
            <form class="form-inline" action="pesquisausuarios.php" method="POST">
            ...
            <tbody>
               ...
               while ($linha =  mysqli_fetch_assoc($dados) ) {
                 ...
                 echo "<tr>
                          ...
                          <td width=150px>
                          <a href='usuarios_edit.php?id=$cod_pessoa' class='btn btn-success btn-sm'>Editar</a>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="excluirusuarios_script.php" method="POST">
